/**
 * E-E-A-T block — Experience, Expertise, Authoritativeness, Trustworthiness.
 * Source: content/medok/index.md
 * Placement: after GEO block, before Footer.
 * Static server component — no JS.
 */

const SOURCES = [
  {
    label: 'Наказ МОЗ України №417 від 15.07.2011',
    desc: '«Про організацію амбулаторної акушерсько-гінекологічної допомоги в Україні»',
  },
  {
    label: 'FMF (Fetal Medicine Foundation)',
    desc: 'Протоколи скринінгу I триместру',
  },
];
...
export default function MedokEeat() {
  return (
    <section
      id="eeat"
      style={{
    ...
    >
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--g900)' }}>
                Кельман Вікторія Володимирівна
              </div>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
          ...
          <div>
            ...
            <ul style={{ margin: 0, padding: 0, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 6 }}>
              {SOURCES.map((s) => (
                <li key={s.label} style={{ fontSize: 12, color: 'var(--g500)', lineHeight: 1.55 }}>
      ...
      <style>{`
        @media(max-width:768px){
          section#eeat{ padding: 28px 20px 32px !important }
          section#eeat > div > div:first-child{ flex-direction: column; gap: 16px }
          section#eeat > div > div:first-child > div:last-child{ margin-left: 0 }
        }
      `}</style>
    </section>
  );
