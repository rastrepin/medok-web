const STEPS = [
  {
    n: 1,
    color: 'var(--td)',
    title: 'Запис та перший прийом',
    desc: 'Телефонуєте або залишаєте заявку. Адміністратор узгоджує зручний час. На першому прийомі лікар проводить огляд і оформлює карту.',
  },
  {
    n: 2,
    color: 'var(--t)',
    title: 'Оформлення пакету «Довіра»',
    desc: 'Обираєте триместровий пакет або повне ведення. Фіксована вартість — платите один раз за весь обсяг послуг. Жодних несподіваних доплат.',
  },
  {
    n: 3,
    color: 'var(--c)',
    title: 'Доступ до особистого кабінету',
    desc: 'Отримуєте посилання на CAREWAY-кабінет — вашу дорожню карту вагітності. Всі заплановані візити, результати аналізів та контакт з лікарем в одному місці.',
  },
  {
    n: 4,
    color: '#7c3aed',
    title: 'Супровід між візитами 24/7',
    desc: 'Отримали аналізи — надсилаєте через застосунок. Лікар перевіряє показники і повідомляє, якщо потрібна реакція. Відповідь без черг та очікування.',
  },
];
