const HUB_ITEMS = [
  {
    ...
    desc: 'Окремий триместр або повне ведення від постановки на облік до пологів. Фіксована вартість — все включено.',
  ...
  {
    title: 'Планове УЗД',
    desc: 'Ваш гінеколог приймає рішення на основі того, що бачить діагност. У MED OK скринінги проводить спеціаліст із сертифікацією FMF (Fetal Medicine Foundation, Лондон) на апараті Voluson E8 — це поєднання, яке дає лікарю повну картину.',
    facts: ['Скринінги I, II, III триместру', '3D/4D — детальна оцінка розвитку'],
    link: '/doctors/bondarchuk-zhanna', linkLabel: 'Про спеціаліста',
    isPrimary: false,
    iconColor: 'var(--tp)',
  },
];
